...
const ORACLE_ABI = [
  'function setOracleEncryptionKey(string algorithm, string publicKey)',
];
...
if (!phalaUrl || !rpcUrl || !privateKey || !oracleAddress) {
  throw new Error('PHALA_API_URL, NEOX_RPC_URL, NEOX_PRIVATE_KEY/PHALA_NEOX_PRIVATE_KEY, and CONTRACT_MORPHEUS_ORACLE_X_ADDRESS are required');
}
