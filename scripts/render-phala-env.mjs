...
const runtimeConfig = {
  ...
  MORPHEUS_FEED_SYMBOLS: get('MORPHEUS_FEED_SYMBOLS') || 'NEO-USD,GAS-USD,FLM-USD,BTC-USD,ETH-USD,SOL-USD,TRX-USD,PAXG-USD,WTI-USD,USDT-USD,USDC-USD,BNB-USD,XRP-USD,DOGE-USD,HYPE-USDT',
...
const lines = [
  ...
  line('MORPHEUS_FEED_SYMBOLS', get('MORPHEUS_FEED_SYMBOLS') || 'NEO-USD,GAS-USD,FLM-USD,BTC-USD,ETH-USD,SOL-USD,TRX-USD,PAXG-USD,WTI-USD,USDT-USD,USDC-USD,BNB-USD,XRP-USD,DOGE-USD,HYPE-USDT'),
