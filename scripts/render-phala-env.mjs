...
const runtimeConfig = {
  ...
  ORACLE_WASM_TIMEOUT_MS:
    get('ORACLE_WASM_TIMEOUT_MS') || get('MORPHEUS_WASM_TIMEOUT_MS') || '30000',
  COMPUTE_SCRIPT_TIMEOUT_MS: get('COMPUTE_SCRIPT_TIMEOUT_MS') || '2000',
  COMPUTE_WASM_TIMEOUT_MS:
    get('COMPUTE_WASM_TIMEOUT_MS') || get('MORPHEUS_WASM_TIMEOUT_MS') || '30000',
...
const lines = [
  ...
  line(
    ...
    get('MORPHEUS_RELAYER_RETRY_MAX_DELAY_MS') || '300000'
  ),
  line(
