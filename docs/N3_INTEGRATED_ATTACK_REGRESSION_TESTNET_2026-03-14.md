...
- callback_boundary: `passed`
  ...
  summary: `{"txid":"0xf6a3001a77067b2291482c20852195bbcbd1c7f38a3ff3f54fe4be0cbc69467c","vmstate":"FAULT","exception":"at instruction 966 (ABORTMSG): ABORTMSG is executed. Reason: unauthorized caller"}`
...
- fulfillment_replay: `passed`
  ...
  summary: `{"replay_exception":"at instruction 3841 (ABORTMSG): ABORTMSG is executed. Reason: invalid verification signature","fulfill_vmstate":"HALT","fulfill_txid":"0xd7dc6547fdbcad3fef60a93abcce2412b89657a2b44020c7fb8ac35190a49e3b"}`
- aa_session_oracle_boundary: `passed`
  report: `examples/deployments/n3-aa-session-oracle-boundary.testnet.latest.json`
  summary: `{"execute_txid":"0x06a687a6ac43bfcaed3feb40b965477d5d448ee967402d004020ad5d84054a99","request_id":"3031","wrong_target_exception":"at instruction 515 (ABORTMSG): ABORTMSG is executed. Reason: Target contract not permitted","wrong_method_exception":"at instruction 556 (ABORTMSG): ABORTMSG is executed. Reason: Method not permitted"}`
