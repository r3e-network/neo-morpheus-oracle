...
public abstract class FeedReaderN3Example(Neo.SmartContract.Testing.SmartContractInitialize initialize) : Neo.SmartContract.Testing.SmartContract(initialize), IContractInfo
{
    #region Compiled data

    public static Neo.SmartContract.Manifest.ContractManifest Manifest => Neo.SmartContract.Manifest.ContractManifest.Parse(@"{""name"":""FeedReaderN3Example"",""groups"":[],""features"":{},""supportedstandards"":[],""abi"":{""methods"":[{""name"":""getNeoUsd"",""parameters"":[{""name"":""dataFeedHash"",""type"":""Hash160""}],""returntype"":""Array"",""offset"":0,""safe"":true},{""name"":""getAllPairs"",""parameters"":[{""name"":""dataFeedHash"",""type"":""Hash160""}],""returntype"":""Array"",""offset"":52,""safe"":true}],""events"":[]},""permissions"":[{""contract"":""*"",""methods"":[""getAllPairs"",""getLatest""]}],""trusts"":[],""extra"":{""nef"":{""optimization"":""Basic""}}}");
