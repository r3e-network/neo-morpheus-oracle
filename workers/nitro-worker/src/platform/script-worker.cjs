...
// sandbox realm's intrinsics rather than the host realm's.
...
// base64 primitive is passed as a closed-over argument to a sandbox-realm
// factory, never placed on the sandbox global, and the helpers only return
// primitive values.
