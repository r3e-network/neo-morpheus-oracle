      ...
      <div className="card-industrial" style={{ padding: '1.5rem' }}>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.75rem' }}>
          <button
            ...
            onClick={() => applyOraclePreset('public_quote')}
          >
          ...
          <button
            className="btn-secondary"
            style={{ border: '1px solid var(--border-dim)' }}
            onClick={() => applyOraclePreset('private_api')}
          >
          ...
          <button
            className="btn-secondary"
            style={{ border: '1px solid var(--border-dim)' }}
            onClick={() => applyOraclePreset('boolean_check')}
          >
          ...
          <button
            className="btn-secondary"
            style={{ border: '1px solid var(--border-dim)' }}
            onClick={() => applyOraclePreset('hidden_builtin')}
          >
          ...
          <div style={{ padding: '1.5rem' }}>
            ...
            <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
              <button
                ...
                onClick={encryptConfidentialPatch}
          ...
          >
            <div style={{ display: 'flex', gap: '0.75rem', flexWrap: 'wrap' }}>
              <button
                className="btn-secondary"
                style={{ border: '1px solid var(--border-dim)' }}
                onClick={() => handleCopy('payload', generatedRequest.payloadJson)}
              >
                <Copy size={14} />{' '}
              ...
              <button
                className="btn-secondary"
                style={{ border: '1px solid var(--border-dim)' }}
                onClick={() => handleCopy('n3', generatedRequest.neoN3Snippet)}
              >
