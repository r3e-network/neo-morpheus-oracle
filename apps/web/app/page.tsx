            ...
            <div className="grid grid-2" style={{ alignItems: 'center', gap: '6rem' }}>
              <div className="stagger-1">
                ...
                <p style={{ color: 'var(--text-secondary)', fontSize: '1.1rem', marginBottom: '2.5rem', lineHeight: 1.7 }}>
                  Access synchronized price pairs stored directly on {NETWORKS.neo_n3.name}. Prices use a global <code>1 USD = 1,000,000</code> integer scale, and updates are scanned every 60 seconds and only published when movement versus the current quantized on-chain value exceeds 0.1%.
                </p>
