...
export default function DocsIntroduction() {
  return (
    <div className="fade-in">
      ...
      >
        Neo Morpheus Oracle is a decentralized privacy-preserving prover network. It uses
        hardware-backed Trusted Execution Environments to bridge sensitive off-chain data into Neo
        N3 callback flows.
      </p>
      ...
      <div className="grid grid-2" style={{ gap: '1.5rem', marginBottom: '4rem' }}>
        ...
        <div className="card-industrial" style={{ padding: '1.5rem' }}>
          ...
          <p style={{ fontSize: '0.85rem', marginBottom: 0 }}>
            Cryptographic proofs (Attestation) guarantee that execution happened exactly as
            programmed.
          </p>
        </div>
      </div>
      ...
      <p>
        Standard oracles broadcast sensitive data—such as API keys, private identity scores, or
        proprietary trading logic—directly onto public ledgers. This transparency prevents smart
        contracts from interacting with most of the world's high-value data.
      </p>
      ...
      >
        <strong>The Morpheus Solution:</strong> By moving logic into the Phala TEE runtime, Morpheus
        creates a secure sandbox where data can be fetched, processed, and signed without ever being
        exposed to node operators or the underlying cloud provider.
      </blockquote>

      <h2>Core Architecture</h2>
      <p>
        The Morpheus ecosystem is composed of three primary layers designed for high availability
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', margin: '2.5rem 0' }}>
        {[
          {
            icon: Zap,
            title: 'On-Chain Registry & verification',
            desc: 'Native contracts track request metadata, fee credits, callback routing, and verifier-key-checked fulfillment.',
          },
          {
            icon: Terminal,
            title: 'Asynchronous Relayer',
            desc: 'A robust event-driven bridge that coordinates between the Neo blockchain events and the Phala TEE worker cluster.',
          },
          {
            icon: Shield,
            title: 'TEE Prover Network',
            desc: 'Hardware-isolated workers that unseal data, execute requests, and generate cryptographically verifiable proofs.',
          },
        ].map((item, i) => (
          <div
            key={i}
      ...
      <div className="grid grid-2" style={{ gap: '1.5rem' }}>
        ...
        >
          ...
          >
            Compare configured feed pairs, current on-chain values, live source values, and
            deprecated legacy keys in one view.
          </p>
        </Link>
        <Link
          href="/docs/neodid"
        ...
        >
          ...
          >
            Review the Oracle-only NeoDID flow, Web3Auth-in-TEE validation path, and the new W3C DID
            resolver surface.
          </p>
        </Link>
      </div>
