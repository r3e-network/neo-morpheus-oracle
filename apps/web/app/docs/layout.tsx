  ...
  const sections = [
    ...
    },
    {
      ...
      items: [
        ...
        { href: '/docs/r/CONTROL_PLANE_REFACTOR_2026-03-20', label: 'Control Plane Refactor', icon: ClipboardList },
        { href: '/docs/r/CONTROL_PLANE_DEPLOY_RUNBOOK_2026-03-20', label: 'Control Plane Deploy Runbook', icon: ClipboardList },
        { href: '/docs/r/RELIABILITY_NOTES_2026-03-20', label: 'Reliability Notes', icon: CheckCircle },
