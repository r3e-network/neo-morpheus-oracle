...
type ProxyOperation = {
  route: string;
  category: "oracle" | "compute" | "feed" | "runtime" | "signing" | "relay" | "attestation" | "system";
...
export async function proxyToPhala(path: string, init: RequestInit = {}, operation?: ProxyOperation) {
